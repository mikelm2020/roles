"""
Django settings for users_menu project.
...
MIDDLEWARE = [
    ...
    "apps.users.middleware.custom_middleware.SessionDurationMiddleware",
]

ROOT_URLCONF = "users_menu.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.menu.context_processors.menu_context_processor",
            ],
        },
    },
]
